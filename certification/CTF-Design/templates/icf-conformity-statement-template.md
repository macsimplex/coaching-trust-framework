...
L'agent [NOM-AGENT] est construit sur le Coaching Trust Framework (CTF) v1.0 — un socle de conformité ICF open source. Il est composé de trois couches :
...
| Exigence | Couverture | Fichier |
|----------|------------|---------|
| E.10.1 — Rapport de tests | 📋 Documentaire | compliance/ — à produire via CTF-Test-Plan |
...
| E.10.1 — Rapport de tests formel | À produire via CTF-Test-Plan | Éditeur |
