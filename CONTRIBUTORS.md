...
- **Status:** Draft pending submission to ICF for endorsement (see [`declinations/ctf-icf/status.md`](./declinations/ctf-icf/status.md) once available)
...
1. Submit a pull request adding your entry to the appropriate section.
2. Include the format specified above.
3. If you prefer not to appear in this file, simply mention it when you submit your contribution; the contribution will still be processed without public acknowledgment.
